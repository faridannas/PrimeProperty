...
export default function AboutSection() {
  ...
  return (
    <section id="tentang-kami" className="bg-prime-white scroll-mt-16">
      {/* Page Header */}
      <div className="bg-prime-black text-prime-white py-20 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-8 md:px-16 text-center relative z-10">
          <h2 className="font-playfair text-4xl sm:text-5xl font-bold mb-6 tracking-tight">Tentang Kami</h2>
          <div className="w-16 h-1.5 bg-prime-gold mx-auto rounded-full"></div>
        </div>
      </div>

      {/* Profil Section (2 columns on md/desktop) */}
      <div className="py-16 sm:py-24 max-w-7xl mx-auto px-4 sm:px-8 md:px-16 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
        <div>
          <h3 className="font-playfair text-3xl font-bold mb-6 text-prime-black">Profil Prime Property</h3>
        ...
        <div className="bg-prime-gray p-8 sm:p-12 rounded-2xl border-l-4 border-prime-gold relative">
          ...
          <p className="font-playfair text-xl sm:text-2xl font-medium text-prime-black leading-snug relative z-10 italic">
      ...
      {/* Visi & Misi */}
      <div className="py-16 bg-prime-black text-prime-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-8 md:px-16 grid grid-cols-1 md:grid-cols-2 gap-12">
          <div className="bg-white/5 p-8 rounded-2xl border border-white/10">
            <h3 className="font-playfair text-2xl font-bold mb-4 text-prime-gold">Visi Kami</h3>
          ...
          <div className="bg-white/5 p-8 rounded-2xl border border-white/10">
            <h3 className="font-playfair text-2xl font-bold mb-4 text-prime-gold">Misi Kami</h3>
      ...
      {/* Nilai Perusahaan */}
      <div className="py-16 sm:py-24 max-w-7xl mx-auto px-4 sm:px-8 md:px-16">
        <div className="text-center mb-16">
          <h3 className="font-playfair text-3xl font-bold mb-4 text-prime-black">Nilai Perusahaan</h3>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {values.map((val, idx) => (
            <div key={idx} className="bg-prime-white border border-gray-200 p-6 rounded-xl hover:border-prime-gold hover:shadow-md transition-all">
              ...
              <h4 className="font-playfair font-bold text-xl mb-2 text-prime-black">{val.title}</h4>
