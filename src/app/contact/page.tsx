...
export default function Contact() {
  ...
  return (
    <PublicLayout>
    <div className="bg-prime-white min-h-screen relative">
      {/* Toast Notification */}
      {showToast && (
      ...
      <div className="bg-prime-black text-prime-white py-20 sm:py-28 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-8 md:px-16 text-center relative z-10">
          <h1 className="font-playfair text-5xl sm:text-6xl font-bold mb-6 tracking-tight">Hubungi Kami</h1>
      ...
      <section className="py-16 sm:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-8 md:px-16 grid grid-cols-1 lg:grid-cols-2 gap-16">
          
          {/* Contact Information */}
          <div>
            <h2 className="text-2xl font-bold mb-8 text-prime-black">Informasi Kontak</h2>
            ...
            <div className="space-y-8">
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-bold text-prime-black mb-1">Alamat Kantor</h3>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-bold text-prime-black mb-1">Nomor Telepon</h3>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-bold text-prime-black mb-1">Email</h3>
              ...
              <div className="flex gap-4">
                ...
                <div>
                  <h3 className="font-bold text-prime-black mb-1">WhatsApp</h3>
                  <a 
          ...
          <div className="bg-white rounded-2xl shadow-[0_0_40px_rgba(0,0,0,0.05)] border border-gray-100 p-8 sm:p-10">
            <h2 className="text-2xl font-bold mb-6 text-prime-black">Kirim Pesan</h2>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className={`w-full bg-prime-black text-prime-white font-bold py-4 rounded-lg flex items-center justify-center gap-2 hover:bg-gray-800 transition-colors ${isSubmitting ? 'opacity-70 cursor-not-allowed' : ''}`}
              >
